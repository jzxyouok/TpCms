...
(function ($, AdminLTE) {
  ...
  var skin_blue =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "</a>"
          + "<p class='text-center no-margin'>蓝黑色</p>");
  ...
  var skin_black =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "</a>"
          + "<p class='text-center no-margin'>黑白色</p>");
  ...
  var skin_purple =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 20px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;'></span></div>"
          + "</a>"
          + "<p class='text-center no-margin'>紫黑色</p>");
  ...
  var skin_green =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 20px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;'></span></div>"
          + "</a>"
          + "<p class='text-center no-margin'>绿黑色</p>");
  ...
  var skin_red =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 20px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;'></span></div>"
          + "</a>"
          + "<p class='text-center no-margin'>红黑色</p>");
  ...
  var skin_yellow =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "<div><span style='display:block; width: 20%; float: left; height: 20px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 20px; background: #f4f5f7;'></span></div>"
          + "</a>"
          + "<p class='text-center no-margin'>黄黑色</p>");
